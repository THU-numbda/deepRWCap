...
MODELS_TO_TRAIN = [
    ...
    {
        "name": "Gradient1Predictor",
        "class": FacePredictor,
        "kwargs": {"head_mode": "norm"},
        "dataset": "gradient_harder",
        "target_face": 1,
        "mainloss": "mse",
    },
    {
        "name": "PoissonSelector",
        "class": FaceSelector,
        "kwargs": {},
        "dataset": "greens_harder",
        "target_face": None,
    ...
    {
        "name": "GradientSelectorWeight",
        "class": FaceSelectorWeight,
        "kwargs": {},
        "dataset": "gradient_harder",
        "target_face": None,
        "mainloss": "mix",
